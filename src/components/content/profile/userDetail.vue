	...
	<div class="userDetail">
		...
		<div class="user-subscribers-list">
			...
			<div class="user-subscribers-list-content" v-show="modes==0">
				...
				<div v-for="(item,index) in selfCreateList" :key='item.id'>
					<div style="position: relative;">
						<i class="iconfont icon-bofang"></i>
			...
			<div class="user-subscribers-list-second" v-show="modes==1">
				...
				<div class="user-subscribers-list-main" v-for="(item,index) in selfCreateList" :key='item.id' :class="index%2?'':'differ'">
					<div>
			...
			<div class="user-subscribers-list-third" v-if="modes==2">
				<div class="user-subscribers-most" v-if="peopleCanSee">
					...
					<div class="user-subscribers-right">
						...
						<div class="user-subscribers-bottom">
							<div class="user-subscribers-bottom-list" v-for="(item,index) in recentSongs" :key='item.song.id' :class="index%2?'':'differ'">
				...
				<div class="user-subscribers-most" v-for="(item,index) in selfCreateList" :key='item.id'>
					...
					<div class="user-subscribers-right">
						...
						<div class="user-subscribers-bottom" v-if="selfSongs[item.id]!=undefined">
							<div class="user-subscribers-bottom-list" v-for="(item,index) in selfSongs[item.id]" :key='item.id' :class="index%2?'':'differ'">
								<span>{{index+1<10?'0'+(index+1):index+1}}</span>
		...
		<div class="user-subscribers-list" v-if="playlist.length!=0">
			...
			<div class="user-subscribers-list-content">
				<div v-for="(item,index) in subscriber" :key='item.id'> 
					<div>
						<i class="iconfont icon-bofang"></i>
						<img v-lazyload="item.coverImgUrl + '?param=180y180'" alt="" @click="reSongDetail(item.id)">
						<div>
							<i class="iconfont icon-bofang1"></i>
